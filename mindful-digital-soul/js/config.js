...
(function () {
    ...
    const PRODUCTION_API = 'https://mindful-digital-soul-api.onrender.com';

    const config = {
        // API base (no trailing slash)
        API_BASE: isLocalhost
            ? 'http://localhost:8000'
            : (PRODUCTION_API !== 'https://mindful-digital-soul-api.onrender.com' ? PRODUCTION_API : 'http://localhost:8000'),
